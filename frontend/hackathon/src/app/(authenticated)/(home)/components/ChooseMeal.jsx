        ...
        <section className="mb-6">
            ...
            <div className="flex space-x-4 mt-6">
                <button 
                    ...
                    BURGER  <Image src="/images/Hambuguer-Emoji.png" alt="Burguer" width={25} height={25} className="ml-1" />
                </button>
                <button 
                    className={`py-2 px-4 rounded-full flex items-center transition-all duration-300 ease-in-out transform hover:scale-105 shadow-lg ${
                    ...
                    BEBIDAS  <Image src="/images/Bebidas-Emoji.png" alt="Bebidas" width={25} height={25} className="ml-1" />
                </button>
            </div>
        </section>
    )
